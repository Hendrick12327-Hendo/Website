...
const RandomAlbum = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen relative">
      <img src={album['Image URL']} alt="Random Album" className="w-1/2 h-auto mb-4 mt-[-500px] transform scale-[0.15]" onError={(e) => { e.target.onerror = null; e.target.src = 'images/album_covers/default.jpg'; }} />
